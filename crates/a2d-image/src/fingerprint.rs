...
///
/// Each byte is the rounded mean luminance of one proportional cell in a 16x24 grid. This stores
/// measurements rather than a duplicate/revision classification: production policy thresholds must
/// be tuned from photographed fixtures before they can be introduced.

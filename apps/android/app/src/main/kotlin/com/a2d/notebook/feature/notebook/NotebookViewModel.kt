...
class NotebookViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun clearTransientResult() {
        update { it.copy(recognizedDesign = null, createdNotebook = null, pageResolution = null, error = null) }
    }
    ...
    fun refreshNotebooks() = runOperation {
        ...
        update { it.copy(notebooks = notebooks) }
    }

    fun resolveSetupCode(payload: String, onRecognized: (NotebookDesignSummary) -> Unit = {}) =
        runOperation {
    ...
    fun createNotebook(request: CreateNotebookRequest) = runOperation {
        ...
        update { it.copy(createdNotebook = created, recognizedDesign = null) }
    }
    ...
    fun resolvePageCode(payload: String, confirmedNotebookId: String?) = runOperation {
        ...
        update { it.copy(pageResolution = resolution) }
    }

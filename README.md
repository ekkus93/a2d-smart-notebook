...
The Android Kotlin binding at
`apps/android/app/src/main/kotlin/uniffi/a2d_ffi/a2d_ffi.kt` is generated source that is committed to
the repository and checked for drift in permanent CI. Regenerate it after every exported `a2d-ffi`
API change with:
...
Do not hand-edit generated Kotlin. Desktop Kotlin and Swift smoke outputs generated by
`tools/generate-bindings.sh` are disposable build artifacts. See `docs/BINDING_GENERATION.md` for the
complete ownership policy, commands, and troubleshooting steps.
